...
import com.agent.brick.ai.AiCommonApi.ChatCompletion.Choice;
import com.agent.brick.ai.AiCommonApi.ChatCompletionChunk.ChunkChoice;
import com.agent.brick.ai.AiCommonApi.ChatCompletionMessage.ChatCompletionFunction;
import com.agent.brick.ai.AiCommonApi.ChatCompletionMessage.Role;
import com.agent.brick.ai.AiCommonApi.ChatCompletionMessage.ToolCall;
 ...
 * @since 0.8.1
 */
public class CommonStreamFunctionCallingHelper {
